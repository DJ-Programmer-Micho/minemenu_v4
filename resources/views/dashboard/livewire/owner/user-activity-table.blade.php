                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            @if($col === 'id')
                                ...
                                <img src="{{ $defualt_link . ($item->user->settings->background_img_avatar ?? $default_img) }}" alt="{{ $item[$col] }}" width="50" style="border-radius: 50%;">
                                @elseif ($col === 'old_plan_id')
                                <span class="text-danger">
                                   <b>{{ $planNames[$item->old_plan_id] }}</b>
                                </span>
