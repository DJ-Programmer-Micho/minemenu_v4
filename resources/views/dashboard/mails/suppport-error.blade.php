                    ...
                    <td valign="middle" class="hero bg_white" style="padding: 2em 0 4em 0;">
                        ...
                        <ul>
                            @foreach ($contact['attachments'] as $attachment)
                                <li><a href="{{ $attachment->url() }}">{{ $attachment->getClientOriginalName() }}</a></li>
                            @endforeach
                        </ul> --}}
                        {{-- <p>Attachments: second way</p>
                        @foreach ($contact['attachments'] as $attachment)
                            @if (strpos($attachment->getMimeType(), 'image') !== false)
                                <img src="{{ $message->embed($attachment->getPathname()) }}" alt="Attachment">
                            @endif
                        @endforeach --}}
                                        ...
                                        <tr>
                                            <td style="text-align: left; padding-left: 10px;">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Call Owner: <a href="telto:+9647501903720">+9647501903720</a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </table>
