...
<div class="subs-text">
    <div class="row d-flex justify-content-center p-0 m-0 navAR">
        <div>
            <h6 style="font-weight: bold">{{__("Your Account is Suspended")}}</h6>
        </div>
    </div>
    <section class="price_plan_area d-flex justify-content-center bg p-0 m-0">
        <div class="text-center">
            <div class="col-12 p-1 fail">
                ...
                <div class="text-center">
                    <h2 style="font-size: 99px;"><i class="fa-solid fa-triangle-exclamation"></i></h2>
                </div>
                    <div class="thanks text-center" style="font-size: 24px">
                        <h2 style="font-size: 28px;">{{__("Account Suspended")}}</h2>
                        <p>{{__("For Violating The MineMenu Rules")}}</p>
                    </div>
