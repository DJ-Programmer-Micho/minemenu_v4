...
<section class="price_plan_area section_padding_130_80 bg" id="pricing">
      ...
      <div class="row justify-content-center w-100">
        ...
        <div class="col-12 col-md-6 p-1 mb-4">
            <div class="single_price_plan wow fadeInUp" data-wow-delay="0.2s"
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1month"
                        aria-expanded="false" aria-controls="collapseExample">Read More
                    </button>
                </div>
        ...
        <div class="col-12 col-md-6 p-1 mb-4">
          <div class="single_price_plan wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse6months"
                    aria-expanded="false" aria-controls="collapseExample">Read More
                </button>
            </div>
          ...
          <!-- Single Price Plan Area-->
          <div class="col-12  col-md-6  p-1 mb-4">
            <div class="single_price_plan wow fadeInUp bo-green active" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
              <!-- Side Shape-->
            ...
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1year"
                    aria-expanded="false" aria-controls="collapseExample">Read More
                </button>
            </div>
