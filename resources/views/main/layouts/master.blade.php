...
<body>
    <body>	
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto py-4 py-md-0">
                                    ...
                                    <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 {{(request()->path() == 'documentation') ? 'active' : ''}}">
        ...
        {{-- <script src="{{asset('/assets/general/lib/lightbox/AutoLightbox.js')}}"></script>
        <script>
            $(document).ready(function() {
                $('.magnify-img').AutoLightbox({
                    width: 'auto',
                    height: 500
                })
            });
        </script> --}}
        {{-- <script src="{{asset('/assets/general/lib/magnify/extm.min.js')}}"></script>
        <script>
            $(document).ready(function() {
                $('.magnify-img').extm({
                    // position: 'overlay',
                    // zoomElement:$(this).attr('src'),
