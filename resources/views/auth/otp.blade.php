...
<body>
    ...
    <div class="container">
        <form id="loginForm" action="{{route('verifyOTP')}}" method="post">
            @csrf
            <h1>
                OTP Code
            </h1>
            <div class="form-content">
                <div class="form-group">
                    <label for="attention">Is That Your Phone Number?</label>
                    <input type="phone" name="phone" value="{{ $phone }}" readonly>
                ...
                <div id="otp-show" class="hide">
                    ...
                    <div class="form-group">
                        ...
                        <input id="entered_otp_code" type="text" class="form-control" name="entered_otp_code" required>
                    </div>
                    <br>
                    <p style="font-size: 16px;">
                        ...
                        <span id="resendLink" style="display:none;">
                            Not received the code? <a href="{{ route('resendPhoneOTP', ['id'=> $id, 'phone' => $phone]) }}" style="color: #cc0022;"><b>Send Code Again</b></a>
                        </span>
                    </p>
